...
Person::Person()
{
    ...
    this->head=new Ball(Point(0.5,0.5,-0.425),0.05f,30,30);
    this->Body=new Cylinder(Point(0.5,0.5,-0.375),0.05f,0.25,30);
    this->leftArm=new Cylinder(Point(0.425,0.5,-0.375),0.025f,0.25,30);
    this->rightArm=new Cylinder(Point(0.575,0.5,-0.375),0.025f,0.25,30);
    this->leftLeg=new Cylinder(Point(0.475,0.5,-0.25),0.025f,0.25,30);
    this->rightLeg=new Cylinder(Point(0.525,0.5,-0.25),0.025f,0.25,30);
    head->render();
    Body->render();
    leftArm->render();
    rightArm->render();
